			  ...
			  <div class="row">
				...
				<div class="col-sm-12 col-md-12">
					<ol class="breadcrumb">
					  	...
					  	<li class="active" >Vulnerabilidades Encontradas</li>
					</ol>
                                ...
                                <div class="box">
                                    <div class="box-header">
                                        <h2><i class="fa fa-bookmark-o"></i>
                                            <font face="MankSans" size="5pt">Vulnerabilidades</font>
                                        </h2>
                                    </div>
											...
											<?php
											    ...
											    foreach($res as $key => $field) {
														...
														$stmt2->bind_result($r_case_id,$r_date,
																			...
																			$r_process_uid, $r_process_uid_score,
																			$r_process_gid, $r_process_gid_score,
																			$r_process_args, $r_process_args_score,
																			$r_process_tcp_banner,$r_process_tcp_banner_score,
