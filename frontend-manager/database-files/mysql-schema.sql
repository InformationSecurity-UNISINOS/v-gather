...
CREATE TABLE `use_cases` (
  ...
  `so_id_weight` FLOAT(4,2) DEFAULT NULL,
  `so_id_score` FLOAT(4,2) DEFAULT NULL,
  `so_version` varchar(30) DEFAULT NULL,
  `so_version_weight` FLOAT(4,2) DEFAULT NULL,
  `so_version_score` FLOAT(4,2) DEFAULT NULL,
  `process_name` varchar(50) DEFAULT NULL,
  `process_name_weight` FLOAT(4,2) DEFAULT NULL,
  `process_name_score` FLOAT(4,2) DEFAULT NULL,
  `process_uid` int DEFAULT NULL,
  `process_uid_weight` FLOAT(4,2) DEFAULT NULL,
  `process_uid_score` FLOAT(4,2) DEFAULT NULL,
  `process_gid` int DEFAULT NULL,
  `process_gid_weight` FLOAT(4,2) DEFAULT NULL,
  `process_gid_score` FLOAT(4,2) DEFAULT NULL,
  `process_args` varchar(50000) DEFAULT NULL,
  `process_args_weight` FLOAT(4,2) DEFAULT NULL,
  `process_args_score` FLOAT(4,2) DEFAULT NULL,
  `process_tcp_banner` varchar(50000) DEFAULT NULL,
  `process_tcp_banner_weight` FLOAT(4,2) DEFAULT NULL,
  `process_tcp_banner_score` FLOAT(4,2) DEFAULT NULL,
  `process_udp_banner` varchar(50000) DEFAULT NULL,
  `process_udp_banner_weight` FLOAT(4,2) DEFAULT NULL,
  `process_udp_banner_score` FLOAT(4,2) DEFAULT NULL,
  `package_name` varchar(120) DEFAULT NULL,
  `package_name_weight` FLOAT(4,2) DEFAULT NULL,
  `package_name_score` FLOAT(4,2) DEFAULT NULL,
  `package_type_id` int(11) DEFAULT NULL,
  `package_type_id_weight` FLOAT(4,2) DEFAULT NULL,
  `package_type_id_score` FLOAT(4,2) DEFAULT NULL,
  `process_binary` varchar(300) DEFAULT NULL,
  `process_binary_weight` FLOAT(4,2) DEFAULT NULL,
  `process_binary_score` FLOAT(4,2) DEFAULT NULL,
  `process_binary_uid` int DEFAULT NULL,
  `process_binary_uid_weight` FLOAT(4,2) DEFAULT NULL,
  `process_binary_uid_score` FLOAT(4,2) DEFAULT NULL,
  `process_binary_gid` int DEFAULT NULL,
  `process_binary_gid_weight` FLOAT(4,2) DEFAULT NULL,
  `process_binary_gid_score` FLOAT(4,2) DEFAULT NULL,
  `process_binary_dac` int DEFAULT NULL,
  `process_binary_dac_weight` FLOAT(4,2) DEFAULT NULL,
  `process_binary_dac_score` FLOAT(4,2) DEFAULT NULL,
  `candidate_final_score` FLOAT(4,2),
