...
CREATE TABLE `use_cases` (
  ...
  `so_id_weight` DECIMAL(3,2) DEFAULT NULL,
  `so_id_score` DECIMAL(3,2) DEFAULT NULL,
  `so_version` varchar(30) DEFAULT NULL,
  `so_version_weight` DECIMAL(3,2) DEFAULT NULL,
  `so_version_score` DECIMAL(3,2) DEFAULT NULL,
  `process_name` varchar(50) DEFAULT NULL,
  `process_name_weight` DECIMAL(3,2) DEFAULT NULL,
  `process_name_score` DECIMAL(3,2) DEFAULT NULL,
  `process_uid` int DEFAULT NULL,
  `process_uid_weight` DECIMAL(3,2) DEFAULT NULL,
  `process_uid_score` DECIMAL(3,2) DEFAULT NULL,
  `process_gid` int DEFAULT NULL,
  `process_gid_weight` DECIMAL(3,2) DEFAULT NULL,
  `process_gid_score` DECIMAL(3,2) DEFAULT NULL,
  `process_args` varchar(50000) DEFAULT NULL,
  `process_args_weight` DECIMAL(3,2) DEFAULT NULL,
  `process_args_score` DECIMAL(3,2) DEFAULT NULL,
  `process_tcp_banner` varchar(50000) DEFAULT NULL,
  `process_tcp_banner_weight` DECIMAL(3,2) DEFAULT NULL,
  `process_tcp_banner_score` DECIMAL(3,2) DEFAULT NULL,
  `process_udp_banner` varchar(50000) DEFAULT NULL,
  `process_udp_banner_weight` DECIMAL(3,2) DEFAULT NULL,
  `process_udp_banner_score` DECIMAL(3,2) DEFAULT NULL,
  `package_name` varchar(120) DEFAULT NULL,
  `package_name_weight` DECIMAL(3,2) DEFAULT NULL,
  `package_name_score` DECIMAL(3,2) DEFAULT NULL,
  `package_type_id` int(11) DEFAULT NULL,
  `package_type_id_weight` DECIMAL(3,2) DEFAULT NULL,
  `package_type_id_score` DECIMAL(3,2) DEFAULT NULL,
  `process_binary` varchar(300) DEFAULT NULL,
  `process_binary_weight` DECIMAL(3,2) DEFAULT NULL,
  `process_binary_score` DECIMAL(3,2) DEFAULT NULL,
  `process_binary_uid` int DEFAULT NULL,
  `process_binary_uid_weight` DECIMAL(3,2) DEFAULT NULL,
  `process_binary_uid_score` DECIMAL(3,2) DEFAULT NULL,
  `process_binary_gid` int DEFAULT NULL,
  `process_binary_gid_weight` DECIMAL(3,2) DEFAULT NULL,
  `process_binary_gid_score` DECIMAL(3,2) DEFAULT NULL,
  `process_binary_dac` int DEFAULT NULL,
  `process_binary_dac_weight` DECIMAL(3,2) DEFAULT NULL,
  `process_binary_dac_score` DECIMAL(3,2) DEFAULT NULL,
  `candidate_final_score` DECIMAL(3,2),
  PRIMARY KEY (`id`),
  KEY `so_id` (`so_id`),
