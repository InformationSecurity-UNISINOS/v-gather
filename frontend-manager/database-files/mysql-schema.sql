...
CREATE TABLE `use_cases` (
  ...
  `process_tcp_portas` varchar(150) DEFAULT NULL,
  `process_tcp_portas_weight` FLOAT(3,2) DEFAULT NULL,
  `process_udp_banner` varchar(50000) DEFAULT NULL,
  `process_udp_banner_weight` FLOAT(3,2) DEFAULT NULL,
  `process_udp_portas` varchar(150) DEFAULT NULL,
  `process_udp_portas_weight` FLOAT(3,2) DEFAULT NULL,
